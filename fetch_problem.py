...
parser.add_argument(
    '-y', type=int, help="The year of the problem", dest="year",  default=datetime.now().year)
parser.add_argument('-p', type=int, dest="problem",
                    help="The problem number", required=True)
